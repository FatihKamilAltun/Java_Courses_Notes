...
public class C003_LinkedList {
    public static void main(String[] args) {
        ...
        // direkt sayi yazarsak index olarak kabul ederdi
        // ama bir variable'a atama yapar ve remove'da o variable'in ismini yazarsak
        ...
        ll1.add("Berk");
        ll1.add("Samet");
        System.out.println(ll1); // [Berk, Samet]
