...
public class C02_MapMethodlari {
    public static void main(String[] args) {
        ...
        106 daha onceden varsa, eskiden var olan degeri
        "eski degeri degistirmek istediginizden emin misiniz" yazdirin

        106'nın oldugunu kontrol etmek icin containsKey() daha mantikli
        ama biz yeni öğrendigimiz method ile yapalim

        map.putIfAbsent (key, value) 00> key varsa
        ekleme yapmaz, bize o key ile kayitli olan value'yi dondurur
        ==> key daha onceden map'e eklenmişse
        ...
        sinifListMap.replace(105,"Erdal, Besikcioglu, Tester");
        sinifListMap.put(109,"Ercument, Cozer, JDev");
        ReusableMethods.entryYazdir(sinifListMap);
