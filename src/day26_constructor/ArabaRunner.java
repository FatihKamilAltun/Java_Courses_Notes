...
public class ArabaRunner {
    public static void main(String[] args) {
        ...
        /*
        Farkli bir package'daki bir class'tan obje olusturugumuzda
        acces modifier'leri da dikkate almaliyiz
         */
        Car car1=new Car();
         ...
         */
         ...
         araba1.yil=2010;
         araba1.model="C180";
         System.out.println("Araba1 bilgielri\nMarka : " + araba1.marka +"\nModel : " + araba1.model
                +"\nYil : " + araba1.yil + "\nFiyat : " + araba1.fiyat);
        /*
        ...
        System.out.println("Araba2 bilgielri\nMarka : " + araba2.marka +"\nModel : " + araba2.model
                +"\nYil : " + araba2.yil + "\nFiyat : " + araba2.fiyat);

        Araba araba3=new Araba("Opel","Astra",2015,78000);
        System.out.println("Araba3 bilgielri\nMarka : " + araba3.marka +"\nModel : " + araba3.model
                +"\nYil : " + araba3.yil + "\nFiyat : " + araba3.fiyat);

        Araba araba4=new Araba("Audi","A5",2020,50000);
        System.out.println("Araba4 bilgielri\nMarka : " + araba4.marka +"\nModel : " + araba4.model
                +"\nYil : " + araba4.yil + "\nFiyat : " + araba4.fiyat);
